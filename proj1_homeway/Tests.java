...
/**
* @author Afonso Maria 61698 as.maria@campus.fct.unl.pt
* @author Joâo Pereirinha 64382 j.pereirinha@campus.fct.unl.pt
*/
 ...
 * These tests use the test files from the Mooshak as input, generating as
 * output
 ...
 * In order to use this class you must include the JUnit 4 library in your
 * execution environment.
 * Ask for help in the lab sessions, if necessary!
 *
 * A classe Tests especifica um conjunto de testes implementado recorrendo 'a
 * ferramenta
 ...
 * Para poder usar esta classe tem de incluir no seu ambiente de execucao a
 * biblioteca JUnit 4.
...
public class Tests {
     ...
     * In this example file, created for the Home Away from Home project, we have 43
     * tests to perform.
     * For each input file, there is a corresponding output file. For example, the
     * expected
     * result for the test inpu1 is output1. You do not need to do anything else in
     * the
     * rest of the class. Just configure this sequence of tests! This is already
     * done for
     ...
     * Neste ficheiro de exemplo, criado para o projecto Home Away from Home, temos
     * 43 testes a realizar.
     * Para cada ficheiro de input, existe um ficheiro de output correspondente. Por
     * exemplo,
     * o resultado esperado para o input1 e output1. Nao tem de fazer mais nada no
     * resto da classe. Basta configurar esta sequencia de testes! Isto ja esta
     * feito para este
    ...
    @Test
    public void test10() {
        test("input10", "output10");
    }

    @Test
    public void test11() {
        test("input11", "output11");
    }

    @Test
    public void test12() {
        test("input12", "output12");
    }

    @Test
    public void test13() {
        test("input13", "output13");
    }

    @Test
    public void test14() {
        test("input14", "output14");
    }

    @Test
    public void test15() {
        test("input15", "output15");
    }

    @Test
    public void test16() {
        test("input16", "output16");
    }

    @Test
    public void test17() {
        test("input17", "output17");
    }

    @Test
    public void test18() {
        test("input18", "output18");
    }
    ...
    /**
     * The consoleStream variable is used to redirect the output of the program to
     * the console.
     ...
     * It redirects the output of the program to the console and captures the output
     * of the program.
     */
    @Before
    public void setup() {
     ...
     * It receives as input the name of the input file and the name of the output
     * file.
     * It reads the input file and the output file, and then executes the program
     * with the input file.
    ...
    /**
     * The removeCarriages method is used to remove the carriage returns from a
     * string.
     * 
     * @param s the string
